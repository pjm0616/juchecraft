...
SRCS_ORDERS			= src/game/orders/Order.cpp src/game/orders/TargetedOrder.cpp src/game/orders/ProductionOrder.cpp src/game/orders/targeted/Order_Move.cpp src/game/orders/targeted/Order_Attack.cpp
